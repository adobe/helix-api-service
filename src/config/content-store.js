...
export class ContentStore {
  /**
   * @param {string} type config type (e.g. 'index)
  ...
  async fetchCreate(ctx, info) {
    ...
    const primary = await checkPrimarySite(ctx, this.contentBusId, info);
    if (primary) {
