...
export default {
  name: 'adobe-stage',
  client: (ctx) => ({
    clientId: ctx.env.HLX_ADMIN_APP_IMS_STG_CLIENT_ID,
    clientSecret: ctx.env.HLX_ADMIN_APP_IMS_STG_CLIENT_SECRET,
  }),
  ...
  routes: {
    login: '/auth/adobe-stg',
    loginRedirect: '/auth/adobe-stg/ack',
  },
};
